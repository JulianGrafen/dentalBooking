-- ============================================================================
-- Public booking availability + Europe/Berlin opening-hour validation
-- ============================================================================
...
begin
  ...
  day_start := booking_date::timestamp at time zone 'Europe/Berlin';
  ...
  where a.practice_id = resolved_practice_id
    and a.status = 'booked'
    and a.start_time >= day_start
    and a.start_time < day_end
